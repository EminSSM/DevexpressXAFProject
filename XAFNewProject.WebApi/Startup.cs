...
using XAFNewProject.WebApi.JWT;
using DevExpress.ExpressApp.Security.Authentication.ClientServer;
using DevExpress.ExpressApp;
using DevExpress.ExpressApp.ApplicationBuilder;

namespace XAFNewProject.WebApi;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXafWebApi(builder => {
            ...
            builder.Modules
                ...
                .AddValidation()
                .Add<XAFNewProject.Module.XAFNewProjectModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(XAFNewProject.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(XAFNewProject.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            builder.AddBuildStep(application => {
                application.ApplicationName = "SetupApplication.XAFNewProject";
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "XAFNewProject API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the XAFNewProject.WebApi\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "XAFNewProject WebApi v1");
            });
        }
        else {
